...
def prune_by_importance(container: Any, importance_threshold: float) -> int:
    ...
    try:
        ...
        logger.error(f"[ERROR] Failed to prune by importance: {e}")
        return 0
...
def prune_by_age(container: Any, days: int = 30) -> int:
    ...
    try:
        ...
        logger.error(f"[ERROR] Failed to prune by age: {e}")
        return 0
...
def prune_by_access_frequency(container: Any, min_accesses: int = 2) -> int:
    ...
    try:
        ...
        logger.error(f"[ERROR] Failed to prune by access frequency: {e}")
        return 0
...
def prune_hybrid(container: Any, max_memories: int) -> int:
    ...
    try:
        ...
        logger.error(f"[ERROR] Failed to prune hybrid: {e}")
        return 0
